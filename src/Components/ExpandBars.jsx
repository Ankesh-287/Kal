...
import { Button, Grid, TextField, Box, Accordion, AccordionSummary, AccordionDetails, Typography, Divider, TableContainer, Paper, Table, TableHead, TableRow, TableBody, TableCell, FormControlLabel, Checkbox, Rating } from '@mui/material'
        ...
        <>
            <Accordion>
                ...
                <AccordionDetails>
                    ...
                    <ul style={{ color: 'grey', fontSize: '14px' }}>
                        <li>
                            You can return your order for any reason, free of charge, within 30 days</li>
                        <li>
                            We also offer a Free-of-Charge shipping label</li>
                    </ul>
